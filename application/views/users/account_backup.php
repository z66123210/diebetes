...
<body>
	...
	echo '<br /> <p> Your name: '.$user['name'];
			echo '<br /> <p> Your age: '. $user['age'] . ' years old';
			echo '<br /> <p> Your Gender: '. $user['sex'];
			echo '<br /> <p> Your Height: '.$user['height'].' m';
			echo '<br /> <p> Your Weight: '.$user['weight']. ' kg';
			echo '<br /> <p> Your BMI: '.$user['bmi'].'. Your classification: '.$user['classification'];
			echo '<br /> <p> Your BMI standards is: 25 . Your weight should be: '.$user['good_weight'];
					...
					<div class="col-md-12">
						<div class="sched d-block d-lg-flex" >
							<div class="text order-1" style="border: solid black 2px; padding: 5px;">
								<h3><span class='span'><?php echo $user['bmi'] ?></span></h3>
								<p>Is Your Current BMI</p>


							</div>
							<div class="text order-1" style="border: solid black 2px;padding: 5px;">
								<h3><span class='span'><?php echo $user['classification'] ?></span></h3>
							...
							<div class="text" style="border: solid black 2px;padding: 5px;">
								<h3><span class='span'><?php echo $user['good_weight'] ?></span> Kg</h3>
					...
					<div class="col-md-12">
						<div class="sched d-block d-lg-flex">
							...
							<div class="text order-1" style="border: solid black 2px;padding: 5px;">
								...
								<h3><span class='span'> <?php echo $user['calories'] ?></span> Kcal/day</h3>
	...
	if ($current_plan->checkplan)
	{
		...
		echo 'Time updated: '. $plan->time_updated;
				...
				if ($meal_levels)
				{
					...
					foreach ($meal_levels as $meal_level)
					{
						// 		echo '<br />';
