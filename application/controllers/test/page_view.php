...
<html>
	<head>
		...
		<link href="<?php echo base_url('lab/assests/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
		<link href="<?php echo base_url('lab/assests/datatables/css/dataTables.bootstrap.css')?>" rel="stylesheet">
	</head>
	<body>
...
<script src="<?php echo base_url('lab/assests/jquery/jquery-3.1.0.min.js')?>"></script>
<script src="<?php echo base_url('lab/assests/bootstrap/js/bootstrap.min.js')?>"></script>
<script src="<?php echo base_url('lab/assests/datatables/js/jquery.dataTables.min.js')?>"></script>
<script src="<?php echo base_url('lab/assests/datatables/js/dataTables.bootstrap.js')?>"></script>
...
<script type="text/javascript">
	...
	function save()
	{
		...
		if(save_method == 'add')
		{
			url = "<?php echo base_url('/lab/index.php/pages/page_add')?>";
		}
		else
		{
			url = "<?php echo base_url('/lab/index.php/pages/page_update')?>";
		}
